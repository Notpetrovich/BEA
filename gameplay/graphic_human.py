...
class PlayerImage():
    def __init__(self, root, canv):
        ...
        self.color_of_hands = 'saddle brown'
        ...
        self.left_hand_obj = canv.create_polygon(0, 0, 0, 0, fill=self.color_of_hands, outline=self.color)
        self.right_hand_obj = canv.create_polygon(0, 0, 0, 0, fill=self.color_of_hands, outline=self.color)
